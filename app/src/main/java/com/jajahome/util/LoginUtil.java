...
public class LoginUtil {
    ...
    private static String SP_NAME="jajaHome";
     ...
     * @param info
     */
    public static void saveInfo(Context mContext,LoginModle info){
        Gson gson=new Gson();
     ...
     * @param mContext
     */
    public static LoginModle getInfo(Context mContext){
        Gson gson=new Gson();
        String gsonInfo=getInfoStr(mContext);
        if(StringUtil.isEmpty(gsonInfo))return null;
        return gson.fromJson(gsonInfo,LoginModle.class);
    }
