...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getViewId() != 0) {
            ...
            if (isSetSpan(getViewId())) {
                SoftPanUtil.setOnTouchOutsideHideSoftPan(this, view);
            }
            setContentView(view);
        }
    ...
    private boolean isSetSpan(int layoutId) {
        return layoutId != R.layout.act_comment && layoutId != R.layout.act_search;
    }
