...
public class PickConfig {
    ...
    public static int DEFAULT_OUT_X= 256;
    public static int DEFAULT_OUT_Y = 256;
    ...
    public final static String EXTRA_OUT_X = "extra_out_x";
    public final static String EXTRA_OUT_Y = "extra_out_x";
    ...
    private PickConfig(Activity context, PickConfig.Builder builder) {
        ...
        this.mOutX = builder.mOutX;
        this.mOutY = builder.mOutY;
        this.actionBarcolor = builder.actionBarcolor;
        ...
        if(mOutX!=0&&mOutY!=0){
            bundle.putInt(EXTRA_OUT_X, this.mOutX);
            bundle.putInt(EXTRA_OUT_Y, this.mOutY);
        }else {
            bundle.putInt(EXTRA_OUT_X, DEFAULT_OUT_X);
            bundle.putInt(EXTRA_OUT_Y, DEFAULT_OUT_Y);
        }
    ...
    public static class Builder {
        ...
        public PickConfig.Builder cropOutX(int x) {
            this.mOutX = x;
            return this;
        }
        public PickConfig.Builder cropOutY(int y) {
            this.mOutY = y;
            return this;
        }
