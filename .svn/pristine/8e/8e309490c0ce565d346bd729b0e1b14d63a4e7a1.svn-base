...
public class ImageFrameLayout extends FrameLayout {
     ...
     * @param url      ：透视图地址
     */
    public void changeImage(String itemId, final SetItemModel.DataBean.ListBean listBean, String url) {
    ...
    private void isAllLoaded(List<ImageView> imageViews, List<SetModel.DataBean.SetBean.ListBean> mList) {
        ...
        if (mLoadedNums == mList.size()) {
            ...
            mOnAllImageLoadedListener.vOrg(imageViews, mList);
    ...
    public interface OnAllImageLoadedListener {
        ...
        void vOrg(List<ImageView> imageViews, List<SetModel.DataBean.SetBean.ListBean> mList);
    }
