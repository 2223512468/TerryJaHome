 ...
 * @author clifford
 */
public class PinchDiyImageView extends ImageView  {
    ...
    public void scaleImg(float x, float y){
        doubleTap(x,y);
    }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PinchDiyImageView pinchImageView);
    }
    ...
    public PinchDiyImageView(Context context) {
        super(context);
        initView();
    }

    public PinchDiyImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinchDiyImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PinchDiyImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PinchDiyImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PinchDiyImageView.this);
