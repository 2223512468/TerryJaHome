package com.jajahome.widget.commontablayout;
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    ...
                    if (position == 0) {
                        EventBus.getDefault().post(new EventMessage(Constant.homeTag, Constant.HOMETABLE));
                    } else if (position == 1) {
                        EventBus.getDefault().post(new EventMessage(Constant.setTag, Constant.HOMETABLE));
                    } else if (position == 2) {
                        EventBus.getDefault().post(new EventMessage(Constant.itemTag, Constant.HOMETABLE));
                    } else if (position == 3) {
                        EventBus.getDefault().post(new EventMessage(Constant.showTag, Constant.HOMETABLE));
                    } else if (position == 4) {
                        EventBus.getDefault().post(new EventMessage(Constant.diyTag, Constant.HOMETABLE));
                    }
