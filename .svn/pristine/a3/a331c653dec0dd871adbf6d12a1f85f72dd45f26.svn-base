...
import com.jajahome.pop.adapter.ItemBrandFilterAdapter;
 ...
 * 修改备注：
 */
public class PopItemBrandFilter implements ItemBrandFilterAdapter.OnItemClick {
	...
	private ItemBrandFilterAdapter adapter;
	public PopItemBrandFilter(Context context, ConfigModel configModel) {
	...
	protected void init( ConfigModel configModel) {
		...
		adapter = new ItemBrandFilterAdapter(mContext, configModel);
	...
	public interface OnItemBrandSelectListener{
		void onItemBrandSelect(int id, String text);
	}
	...
	public void onItemClick(int id, String text) {
		...
		listener.onItemBrandSelect(id,text);
	}
}
