package com.jajahome.widget.horizontalrecycle;
...
public class AutoMoveRecycleView extends RecyclerView {
	...
	public AutoMoveRecycleView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public AutoMoveRecycleView(Context context, AttributeSet attrs, int defStyle) {
