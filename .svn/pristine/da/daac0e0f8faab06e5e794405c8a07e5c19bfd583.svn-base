 ...
 * 修改备注：
 */
public abstract class BaseRecyclerWuLiuAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(mContext).inflate(mLayoutId, null, false);
