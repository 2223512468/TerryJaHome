 ...
 * 修改备注：
 */
public class PopItemStyleFilter implements ItemStyleFilterAdapter.OnItemClick {
	private Context mContext;
	private PopupWindow mPopupWindow;
	private ListView mList;
	private ConfigModel mConfigModel;

	public void setListener(OnItemStyleListner listener) {
		this.listener = listener;
	}

	private OnItemStyleListner listener;
	private TextView mTvTitle, mTvBack;
	private ItemStyleFilterAdapter adapter;
	public PopItemStyleFilter(Context context, ConfigModel configModel) {
	...
	protected void init( ConfigModel configModel) {
		...
		adapter = new ItemStyleFilterAdapter(mContext, configModel);
	...
	public interface OnItemStyleListner{
		void onItemStyleSelect(int id, String text);
	}
	...
	public void onItemClick(int id, String text) {
		...
		listener.onItemStyleSelect(id,text);
	}
}
